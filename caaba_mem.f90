! Time-stamp: <2020-08-13 14:06:09 sander>
...
!  !original zmbl_array (ERA5) for Leicester, UK simulations
!  REAL(DP) , DIMENSION(0:23) :: zmbl_array &
!                              = (/ 621._DP, 599._DP, 580._DP, 561._DP, 550._DP, 556._DP, &
!                                 567._DP,587._DP,622._DP,749._DP,904._DP,1037._DP, &
!                                 1141._DP,1204._DP,1234._DP,1228._DP,1132._DP,878._DP, &
!                                 735._DP, 692._DP, 677._DP, 668._DP,630._DP,608._DP /)
!
!!zmbl_array for IITD simulations:
  REAL(DP) , DIMENSION(0:23) :: zmbl_array &
                              = (/ 465._DP, 671._DP, 832._DP, 830._DP, 918._DP, 845._DP, &
                                 601._DP,512._DP,528._DP,506._DP,445._DP,367._DP, &
                                 347._DP,300._DP,200._DP,100._DP, 90._DP, 70._DP, &
                                 50._DP, 60._DP, 70._DP, 75._DP,100._DP,285._DP /)
!  !mz_hr_20160508- 
  ...
  CHARACTER(LEN=12) ::  aqueous_scenario = ''
