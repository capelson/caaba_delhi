!*****************************************************************************
! Time-stamp: <2020-06-30 11:44:28 b302010>
!*****************************************************************************
...
CONTAINS
  ...
  SUBROUTINE mecca_aero_calc_k_ex( &
    ...
    k_exf, k_exb, k_exf_N2O5, k_exf_ClNO3, k_exf_BrNO3, k_exf_ClNO2)
    ...
    REAL(DP), INTENT(OUT) :: k_exf_ClNO2(:)
    ...
    DO jb = 1, APN
      IF ((ind_H2O_a(jb)/=0).AND.(loghet(jb))) THEN
        ...
        k_exf_ClNO2(jb) = k_exf(jb,IND_ClNO2) / zhetT
        k_exf_BrNO3(jb) = k_exf(jb,IND_BrNO3) / zhetT
      ELSE
        k_exf_N2O5(jb)  = 0._DP
        k_exf_ClNO3(jb) = 0._DP
        k_exf_ClNO2(jb) = 0._DP
